...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/nikita/VS_Code_Projects/Kafka_python/kafka-python-getting-started/env'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/nikita/VS_Code_Projects/Kafka_python/kafka-python-getting-started/env/bin/deactivate.nu'
